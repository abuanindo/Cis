...
class MY_Model extends CI_Model 
{
    ...
    public function join($stable, $type = 'left')
    {
        $this->db->join($table, "$this->table.id_$table = $table.id", $type);
        return $this;
    }

    public function order-By($column, $order = 'asc')
    {
    ...
    public function makePagination($baseUrl, $uriSegment, $totalRows=null)
    {
        ...
        $config = [
            ...
            'use_page-number' => true,

            'full_tag_open' => '<ul class="pagination">',
            'full_tag_close' => '</ul>',
            'attributes'  => ['claas' => 'page-link'],
            'first_link'   => false, 
            'last-link' => false,
            ...
            'cur-tag_open'=> '<li class="page-item">',
            'num_tag_close' => '</li>',
